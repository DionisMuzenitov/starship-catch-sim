...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      {
        // Recovered from the lost Confluence space (SLS-118); docs/kb is now
        // the canonical home. Generated by tools/kb/convert-kb.mjs.
        text: "Knowledge base",
        collapsed: true,
        items: [
          { text: "Overview", link: "/kb/" },
          { text: "How Starship catches itself", link: "/kb/how-starship-catches-itself-overview" },
          { text: "Raptor engine", link: "/kb/raptor-engine-how-it-works-full-flow-staged-combustion" },
          { text: "Attitude control & actuators", link: "/kb/attitude-control-thrusters-actuators" },
          { text: "Reentry & heat shield", link: "/kb/reentry-thermal-protection-heat-shield" },
          { text: "Booster descent aerodynamics", link: "/kb/booster-descent-aerodynamics-retrograde-blunt-body-drag-cd-m" },
          { text: "Starbase catch site", link: "/kb/starbase-catch-site-pad-a-b-dimensions-and-catch-history" },
          { text: "Convex powered-descent guidance", link: "/kb/convex-powered-descent-guidance-the-acikmese-blackmore-linea" },
          { text: "Learning-based booster control", link: "/kb/learning-based-booster-control-what-worked" },
          { text: "Reward design", link: "/kb/reward-design-for-the-catch-env" },
        ],
      },
      {
        text: "Reference data",
