...
| `apps/web/public/assets/terrain/*.height.png`, `*.drape.a.jpg` | [USGS 3DEP](https://www.usgs.gov/3d-elevation-program) (DEM, both tiers); imagery: [USDA NAIP](https://www.usgs.gov/centers/eros/science/usgs-eros-archive-aerial-photography-national-agriculture-imagery-program-naip) WMS (near tier) + [USGS The National Map Imagery-Only base map](https://basemap.nationalmap.gov/) (wide tier — NAIP-derived over CONUS) | USGS / USDA FSA | US public domain — TNM: "free and in the public domain. There are no restrictions"; courtesy credit requested | 2026-07-11 | Baked via `tools/assets/bake-terrain.mjs` (SLS-57 / ADR-018); no-coverage areas (open Gulf, Mexico side) filled procedurally. Credit: U.S. Geological Survey; USDA Farm Service Agency. |
