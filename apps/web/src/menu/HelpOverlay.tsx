...
const HOTKEY_GROUPS: readonly HotkeyGroup[] = [
  ...
  },
  {
    ...
    keys: [
      ...
      { keys: "left-drag", action: "orbit (chase / tower) · look around (ground / free)" },
      { keys: "wheel", action: "zoom (chase / tower) · dolly (free)" },
      { keys: "WASD + R / F", action: "fly the free camera (move + up / down)" },
